...
class Agendamento(models.Model):
    ...
    def __str__(self):
        servico_nome = self.servico.nome if self.servico else "Sem serviço" #tudo na mesma linha
        return f"{self.cliente_nome, self.barbeiro, self.data_agendada or f'Anônimo - {self.Servico.nome}'}"
