...
O **Sistema de Barbearia** é um projeto acadêmico desenvolvido com o objetivo de simular o fluxo operacional de uma barbearia real, incluindo **agendamento**, **gestão de clientes** e **organização de serviços** com a orientação do professor [Diego Cirilo](github.com/dvcirilo).
